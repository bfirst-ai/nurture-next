  ...
  return (
    <div className="min-h-[100dvh] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-navy relative overflow-hidden text-white">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="text-center text-4xl font-bold font-display text-white">
          Welcome back
        </h2>
      </div>
      ...
      >
        <div className="bg-white/5 backdrop-blur-xl py-10 px-6 sm:rounded-3xl sm:px-10 border border-white/10 shadow-2xl">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-2">
                <Input
                  ...
                  className="w-full h-12 bg-white/10 border-white/20 text-white rounded-xl focus:border-primary focus:ring-primary/50"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-bold text-gold hover:text-gold/80 transition-colors">
                  Forgot password?
                </a>
              </div>
            </div>
            ...
            <div>
              <Button type="submit" className="w-full h-12 text-base font-bold rounded-xl bg-primary text-white hover:bg-primary/90 transition-all">
                Sign In
              </Button>
            </div>
            ...
            <div className="relative mt-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-navy px-2 text-white/50">or</span>
              </div>
            </div>

            <div className="mt-8">
              <Button type="button" variant="outline" className="w-full h-12 rounded-xl bg-white text-black hover:bg-white/90 border-transparent font-bold">
          ...
          <p className="mt-8 text-center text-sm text-white/70">
            <Link href="/signup" className="font-bold text-gold hover:text-gold/80 transition-colors">
