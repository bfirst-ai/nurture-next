(function () {
  ...
  var primaryColor = ds.color  || '#0f172a';
  var textColor    = ds.textColor || '#f8fafc';
  ...
  style.textContent =
    ...
    '.accumax-widget-launcher:hover{background:#1e293b;transform:scale(1.08);box-shadow:0 8px 24px rgba(0,0,0,.45);}' +
